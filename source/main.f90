...
elseif (is_arg('-h')) then
  ...
  print '(a)', '        must be extrated, separate them with commas without blank spaces and enclose them in square brakets.'
  ...
  print '(a)', '        in quotes, separate them with commas without blank spaces and enclose them in square brakets.'
  ...
  print '(a)', ' '
  print '(a)', '    -l <file>'
  print '(a)', '        List the content of <file>, ignore the rest of arguments and exit'
  print '(a)', ' '
  print '(a)', '    -l1'
  ...
  print '(a)', 'be a valid input file to read fields stored in files "frame_1.bf3", "frame_2.bf3" and "frame_3.bf3 and"'
  ...
  print '(a)', '      <Collection>'
  print '(a)', '        <DataSet timestep="0.11" group="" part="0" file="frame_1.bf3"/>'
  print '(a)', '        <DataSet timestep="0.22" group="" part="0" file="frame_2.bf3"/>'
  print '(a)', '        <DataSet timestep="0.33" group="" part="0" file="frame_3.bf3"/>'
  print '(a)', '      </Collection>'
  print '(a)', '    </VTKFile>'
  print '(a)', ' '
  ...
  print '(a)', 'associated with mesh file "mesh.bf3" and link them to parameter values "0.11", "0.22" and "0.33":'
  print '(a)', ' '
  print '(a)', '    <?xml version="1.0"?>'
  print '(a)', '    <VTKFile type="Collection" version="0.1" byte_order="LittleEndian">'
  print '(a)', '      <Collection grid="mesh.bf3">'
  ...
  print '(a)', ' '
  print '(a)', '    To convert a BF3 mesh file plus a DEX field file into a VTU (mesh and field) file:'
  print '(a)', ' '
  print '(a)', '       feconv -if field1.dex mesh1.bf3 file2.vtu'
  print '(a)', ' '
  ...
  print '(a)', ' '
  print '(a)', '       feconv -in [''undefined'',''v(2)''] -of field2.ip -in [''uds-0'',''x-velocity'',''y-velocity''] '//&
              &'file1.vtu mesh2.msh' 
  print '(a)', ' '
