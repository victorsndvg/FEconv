...
elseif (is_arg('-h')) then
  ...
  print '(a)', ' '
  print '(a)', '    -ff'
  print '(a)', '        When a .msh file appears as output file, format applied is FreeFem++ MSH format; if absent, '
  print '(a)', '        format applied is ANSYS MSH format.'
  print '(a)', ' '
  ...
  print '(a)', '        mesh file is indicated after option -ef.'
  print '(a)', ' '
  print '(a)', '    -ef <file>'
  print '(a)', '        File where to save the extracted mesh. The subdomain references to be extracted are indicated with -es.'
  print '(a)', '        If -ef is missing when -es appears, <file> is taken as <outfile>__extracted.'
  print '(a)', ' '
  print '(a)', '    -p <n>'
  ...
  print '(a)', '    Modulef Unformatted Mesh (.mum), FreFem++ Tetrahedral Mesh (.msh), FreFem++ Tetrahedral Mesh (.mesh).'
  print '(a)', ' '
