...
elseif (is_arg('-h')) then
  ...
  print '(a)', ' '
  print '(a)', '    -cn'
  print '(a)', '        Save every elementwise field as a nodewise in the output file.'
  print '(a)', '         If absent and the ouput field format does not permit to save elementwise fields, those are discarded.'
  print '(a)', ' '
!  print '(a)', '    -glue'
