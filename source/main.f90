...
!  print '(a)', ' '
  ...
  print '(a)', ' '
  print '(a)', 'NAME RULES'
  print '(a)', '    Feconv let you work with files in different folders, e.g. feconv ../inputmesh.vtu ../outputmesh.unv'
  print '(a)', '    For this reason you cannot use the slash inside the filenames (/ on Linux, \ on Windows)'
  print '(a)', ' '
  print '(a)', '    In addition, due to operating system restrictions, you cannot use blanks or the following characters'
  print '(a)', '    in filenames: < > : " / | ? *'
  print '(a)', ' '
  print '(a)', '    During the field conversion, when the filenames are automatically generated this characters will be'
  print '(a)', '    replaced by X.'
  print '(a)', ' '
  print '(a)', 'EXAMPLES'
