...
! csize
!-----------------------------------------------------------------------
function csize(int1, int2, int3, real1, real2, real3, dbl1, dbl2, dbl3, char1, char2, char3, log1, log2, log3, d) result(res)
...
!! `end program`  
!!
!! @note Fortran standard states that an unallocated array does not have size. Procedure `csize` returns zero in such case.  
!!
