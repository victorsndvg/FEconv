...
print*, 'call insert_sorted(v, 1, n, fit=.false.)'
         call insert_sorted(v, 1._real64, n, fit=.false.)
print*, 'n = ', n, ' v = ', v
print*, 'call insert_sorted(v, 2, n, fit=.false.)'
         call insert_sorted(v, 2._real64, n, fit=.false.)
print*, 'n = ', n, ' v = ', v
print*, 'call insert_sorted(v, 1, n, fit=.false.)'
         call insert_sorted(v, 1._real64, n, fit=.false.)
print*, 'n = ', n, ' v = ', v
...
print*, 'call set(v,[4,2,1], [1,2,3]); call ssort(v)'
         call set(v,[4._real64,2._real64,1._real64], [1,2,3]); call ssort(v)
if (.not. allocated(v)) stop 'Error, v not allocated'
print*, v

print*, 'Sort an array:'
print*, 'call set(v,[4,2,1], [1,2,3]); x = sort(v)'
         call set(v,[4._real64,2._real64,1._real64], [1,2,3]); x = sort(v) 
         ! allocate(x, source=sort(v))
...
print*, 'call set(v,[4,2,1], [1,2,3]); p = find_first(v, 1)'
         call set(v,[4._real64,2._real64,1._real64], [1,2,3]); p = find_first(v, 1._real64)
print*, p

print*, 'Find all the positions of a scalar value in the array:'
print*, 'call set(v,[4,2,1,1], [1,2,3,4]); x = find(v, 1)'
call dealloc(x)
         call set(v,[4._real64,2._real64,1._real64,1._real64], [1,2,3,4]); !allocate(x, source = find(v, 1._real64)) 
         x = find(v, 1._real64)
if (.not. allocated(x)) stop 'Error, x not allocated'
print*, x
...
call dealloc(x)
         call set(v,[4._real64,2._real64,1._real64,1._real64], [1,2,3,4]); x = find(v, [1._real64,2._real64]) 
         ! allocate(x, source = find(v, [1,2]))
if (.not. allocated(x)) stop 'Error, x not allocated'
print*, x

print*, 'Find all the positions of a scalar value in the array:'
print*, 'call set(v,[4,2,1,1], [1,2,3,4]); call sfind(v, 1, x)'
         call set(v,[4._real64,2._real64,1._real64,1._real64], [1,2,3,4]); call sfind(v, 1._real64, x)
if (.not. allocated(x)) stop 'Error, x not allocated'
print*, x

print*, 'Find all the positions of an array of values in the array:'
print*, 'call set(v,[4,2,1,1], [1,2,3,4]); call sfind(v, [1,2], x)'
         call set(v,[4._real64,2._real64,1._real64,1._real64], [1,2,3,4]); call sfind(v, [1._real64,2._real64], x)
if (.not. allocated(x)) stop 'Error, x not allocated'
print*, x
